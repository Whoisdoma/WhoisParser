...
namespace Whoisdoma\WhoisParser;

use Whoisdoma\WhoisParser\Adapter\AbstractAdapter;
use Whoisdoma\WhoisParser\Config\Config;
use Whoisdoma\WhoisParser\Exception\AbstractException;
use Whoisdoma\WhoisParser\Exception\NoAdapterException;
use Whoisdoma\WhoisParser\Exception\NoQueryException;
use Whoisdoma\WhoisParser\Exception\NoTemplateException;
use Whoisdoma\WhoisParser\Exception\RateLimitException;
use Whoisdoma\WhoisParser\Result\Result;
...
class Parser
{
     ...
     * 
     * @var \Whoisdoma\WhoisParser\Result\Result
     * @access protected
     */
    protected $Result;
